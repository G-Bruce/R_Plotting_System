...
# -------------------------------------------- IMPORT RAW DATA ----------------------------------------------------
rm("raw_data","rd_complete_cases","StartOfOperation","TotalProcessorTime", "rd_cc_dates", "rd_cc_ss_active",
   "rd_cc_ss_dt_strptime", "Sub_Metering_1", "Sub_Metering_2", "Sub_Metering_3")
...
rd_cc_ss_voltage <- rd_cc_dates$Voltage
rd_cc_ss_Reactive <- rd_cc_dates$Reactive


# ------------------------------------ PLOTTING -------------------------------------------------------------------
# ----------- PLOT 4 GLOBAL ACTIVE POWER - GLOBAL REACTIVE POWER - VOLTAGE - SUBMETERING --------------------------
...
plot(rd_cc_ss_dt_strptime, rd_cc_ss_voltage, type="l", xlab="Date/Time", ylab="Voltage")
...
plot(rd_cc_ss_dt_strptime, rd_cc_ss_Reactive, type="l", xlab="Date/Time", ylab="Global Reactive Power")
dev.off()
# --------------------------------- CLOSEOUT PROCESSES ------------------------------------------------------------
